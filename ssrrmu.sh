...
export PATH
SCPdir="/etc/newadm" && [[ ! -d ${SCPfrm} ]] && mkdir ${SCPfrm}
...
Separator_1="$(barra)”$(barra)”â€”â€”â€”â€”â€”â€”"
...
clear
	SSR_installation_status
	echo && echo -e "    ADMINISTRADOR DE USUARIOS SS-RR \033[1;32m[NEW-ADM-PLUS]
$(msg -bar)
...
$(barra) Modificar la Configuracion del Usuario\n$(barra)
...
$(barra) Otras Configuraciones $(barra)
...
menu
    ...
    stty erase '^H' && msg -ne "$(fun_trans "Seleccione una opción:") 》" && read num
	msg -bar
case "$num" in
	1)
	Install_SSR
