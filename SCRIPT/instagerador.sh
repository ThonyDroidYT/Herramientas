...
echo -e "\033[0;34m==============\033[0;31mKEY GENERATOR ADM-ULTIMATE-ORIGINAL\033[0;34m==============\033[0m"
...
echo "/usr/bin/gerar.sh" > /usr/bin/keygen && chmod +x /usr/bin/keygen
echo -e "\033[1;33m Perfecto, Use el Comando \033[1;31mgerar.sh o gerar o keygen \033[1;33mpara Administrar Sus Keys y Actualizar la Base del servidor"
echo -e "\033[0;34m======================================================\033[0m"
} || {
echo -e "\033[0;34m======================================================\033[0m"
