...
dankel () {
apt-get update && apt-get upgrade -y: wget https://raw.githubusercontent.com/ThonuDroidYT/ADM-MANAGER-DANKELTHAHER-FREE/master/Dankelthaher.sh; chmod 777 Dankelthaher.sh && ./Dankelthaher.sh
}
vpspack () {
